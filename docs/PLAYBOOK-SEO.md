...
| 2026-07-19 | Villanova | ✅ **Autoridade legítima — 18º registro Zenodo redigido:** whitepaper *Supplier Evidence Maturity Model (SEMM)* em `docs/villanova/`, no padrão honesto da série existente (17 DOIs, ORCID 0009-0001-8072-6287). Artefato citável (modelo + matriz) mirando "supplier evidence"/"eudr compliance checklist". Pontos jurídicos marcados ⚠️ p/ Marcio conferir antes do depósito. | Depende do Marcio: conferir datas legais, depositar no Zenodo, mandar o DOI |
