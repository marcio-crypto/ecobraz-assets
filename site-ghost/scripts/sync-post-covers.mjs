...
const ICONS = {
  ...
  phone: ['M7 2h10a1.5 1.5 0 0 1 1.5 1.5v17A1.5 1.5 0 0 1 17 22H7a1.5 1.5 0 0 1-1.5-1.5v-17A1.5 1.5 0 0 1 7 2z', 'M10.5 18.5h3'],
  gamepad: ['M7 6.5h10a5 5 0 0 1 5 5v1.5a5 5 0 0 1-5 5H7a5 5 0 0 1-5-5V11.5a5 5 0 0 1 5-5z', 'M6.5 12.2h4', 'M8.5 10.2v4', 'M15 13.4h.01', 'M17.5 11h.01'],
  atom: ['M12 12m-9 0a9 3.6 0 1 0 18 0a9 3.6 0 1 0-18 0', 'M12 12m-3.6 0a3.6 9 0 1 0 7.2 0a3.6 9 0 1 0-7.2 0', 'M12 12h.01'],
  music: ['M9 18V5.5l12-2.5v12', 'M6 21a3 3 0 1 0 0-6 3 3 0 0 0 0 6z', 'M18 18a3 3 0 1 0 0-6 3 3 0 0 0 0 6z'],
  film: ['M4 3h16v18H4z', 'M8 3v18', 'M16 3v18', 'M4 9h4', 'M4 15h4', 'M16 9h4', 'M16 15h4'],
  camera: ['M4 7.5h3l2-2.5h6l2 2.5h3V20H4z', 'M12 16.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z'],
};
...
const KICKERS = {
  ...
  phone: 'Museu — telefonia', gamepad: 'Museu — games', atom: 'Museu — ciência',
  music: 'Museu — som', film: 'Museu — imagem', camera: 'Museu — imagem',
};
...
const SLUG_ICON = {
  ...
  // Migração ecobrazinforma — Museu do Eletrônico
  'bina-a-invencao-brasileira-que-identificou-o-telefone-do-futuro': 'phone',
  'iphone-5-2012-o-smartphone-que-afinou-a-era-retina': 'phone',
  'orelhao-design-tecnologia-e-cidadania-urbana': 'phone',
  'apple-ii-o-micro-que-levou-computador-para-casa': 'laptop',
  'ibm-pc-5150-o-computador-que-definiu-a-era-dos-pcs': 'laptop',
  'zx81-o-micro-de-1-kb-que-colocou-computador-na-sala-estar': 'laptop',
  'altair-8800-1975-a-arquitetura-s100-e-microcomputacao': 'cpu',
  'eniac-1945-a-engenharia-do-primeiro-computador-modular': 'cpu',
  'pdp11-o-minicomputador-que-moldou-a-computacao-moderna': 'cpu',
  'do-microprocessador-ao-computador-pessoal-a-era-digital-comeca': 'cpu',
  'o-primeiro-circuito-integrado-brasileiro': 'cpu',
  'a-ultracentrifuga-brasileira-e-o-dominio-do-ciclo-nuclear': 'atom',
  'o-primeiro-microscopio-eletronico-fabricado-no-brasil': 'atom',
  'fotografo-de-placa-vidro-a-precisao-da-luz-em-cristal': 'camera',
  'projetor-dos-irmaos-lumiere-o-nascimento-do-cinema': 'film',
  'televisao-a-cores-o-espetaculo-visual-do-seculo-xx': 'tv',
  'telegrafo-de-morse-o-inicio-da-era-das-mensagens-eletricas': 'router',
  'radio-experimental-de-nikola-tesla-o-nascimento-da-comunicacao-sem-fio': 'router',
  'fonografo-de-edison-o-som-gravado-pela-primeira-vez': 'music',
  'maquina-de-costura-eletrica-singer-o-motor-que-vestiu-mundo': 'plug',
  'sony-playstation-1-a-revolucao-dos-videogames-em-cd': 'gamepad',
  'sony-playstation-2-o-videogame-que-dominou-mundo': 'gamepad',
  'atari-2600-o-videogame-que-levou-os-jogos-para-casa': 'gamepad',
  'sega-master-system-1985-z80a-tec-toy-e-o-pause-no-console': 'gamepad',
  'neo-geo-aes-1990-cartuchos-gigantes-e-hardware-arcade': 'gamepad',
  'magnavox-odyssey-1972-eletronica-discreta-e-patentes': 'gamepad',
  // Migração ecobrazinforma — Notícias ESG e séries
  'o-desastre-de-minamata-a-ameaca-do-mercurio-e-alerta-global': 'alert',
  'itaiitai-o-cadmio-a-agua-e-agonia-dos-ossos': 'alert',
  'anniston-e-o-pcb-a-tragedia-do-veneno-eterno-lixo-eletronico': 'alert',
  'agbogbloshie-o-maior-desastre-de-lixo-eletronico-do-mundo': 'alert',
  'deepwater-horizon-o-colapso-e-vazamento-toxico': 'alert',
  'cubatao-chuva-acida-e-o-ar-envenenado-pelo-progresso': 'leaf',
  'quais-componentes-de-um-eletronico-podem-ser-reciclados': 'recycle',
  'obsolescencia-programada-nos-carros-eletricos': 'battery',
  'adote-um-bairro-a-engenharia-por-tras-do-esg-urbano': 'map',
  'novo-marco-da-cvm-o-fim-do-esg-de-fachada-nas-empresas': 'shield',
  'auditabilidade-esg-o-fim-da-era-do-greenwashing-em-2026': 'shield',
  'descarte-de-ti-venda-sucata-ou-compra-de-risco': 'drive',
  'o-deficit-que-enterra-43-milhoes-de-arvores-no-brasil': 'leaf',
  'mineracao-urbana-a-geopolitica-dos-minerais-criticos': 'recycle',
  'monitores-quebrados-o-chumbo-e-o-mercurio-exigem-destino-unico': 'tv',
  'por-que-criei-o-museu-virtual-do-eletronico': 'book',
  'museu-itinerante-levando-a-historia-da-tecnologia-a-shoppings-e-eventos': 'book',
  'o-caso-funko-pop-quando-estoque-vira-entulho': 'box',
  'brasil-proibe-exportacao-de-lixo-eletronico-bruto-e-cria-reserva-estrategica': 'truck',
  'reserva-de-mercado-1984-a-era-da-engenharia-reversa': 'building',
};
